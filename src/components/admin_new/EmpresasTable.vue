            ...
            >
              <td class="px-6 py-4">
                <div class="flex items-center gap-3">
                  <div class="w-10 h-10 rounded-lg bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center text-white font-semibold">
                    {{ tenant.name[0] }}
                  </div>
                  <div>
              ...
              <td class="px-6 py-4">
                <div class="flex items-center gap-2">
                  ...
                  >
                    <Settings class="w-4 h-4 text-slate-400 group-hover:text-emerald-400 stroke-[1.5]" />
                  </button>
                </div>
              </td>
            </tr>
