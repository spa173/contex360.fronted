    ...
    <div class="flex items-center justify-between pb-2">
      <div>
        ...
        <p class="text-sm text-slate-500">
          {{ demoRequests.length }} solicitudes registradas
        </p>
      </div>
            ...
            >
              ...
              <td class="px-6 py-4">
                ...
                >
                  <option
                    value="nuevo"
                    :selected="req.estado === 'nuevo'"
                  >
                    Nuevo
                  </option>
                  <option
                    value="contactado"
                    :selected="req.estado === 'contactado'"
                  >
                    Contactado
                  </option>
                  <option
                    value="demo_agendada"
                    :selected="req.estado === 'demo_agendada'"
                  >
                    Demo agendada
                  </option>
                  <option
                    value="aprobado"
                    :selected="req.estado === 'aprobado'"
                  >
                    Aprobado
                  </option>
                  <option
                    value="convertido"
                    :selected="req.estado === 'convertido'"
                  >
                    Convertido
                  </option>
                  <option
                    value="cliente"
                    :selected="req.estado === 'cliente'"
                  >
                    Cliente
                  </option>
                </select>
