    ...
    <div class="flex items-center gap-1.5">
      ...
      <div class="relative" data-dropdown>
        ...
        <Teleport to="body" :disabled="!isMobile">
          <div v-if="showNotifications && isMobile" class="fixed inset-0 z-[199] bg-black/20" @click="showNotifications = false"></div>
          <div
            v-if="showNotifications"
            data-dropdown
            :class="isMobile
              ? 'fixed top-[60px] left-3 right-3 z-[200] max-h-[calc(100dvh-5rem)] overflow-y-auto bg-white border border-[#E4E4E7] rounded-[14px] shadow-[0_1px_2px_rgba(0,0,0,0.02),0_24px_60px_-20px_rgba(10,10,10,0.18)] animate-in fade-in slide-in-from-top-2 duration-200'
              : 'absolute right-0 top-full mt-1.5 w-[300px] bg-white border border-[#E4E4E7] rounded-[14px] shadow-[0_1px_2px_rgba(0,0,0,0.02),0_24px_60px_-20px_rgba(10,10,10,0.18)] overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-200'"
          >
      ...
      <div class="relative" data-dropdown>
        ...
        <Teleport to="body" :disabled="!isMobile">
          <div v-if="showAvatar && isMobile" class="fixed inset-0 z-[199] bg-black/20" @click="showAvatar = false"></div>
          <div
            v-if="showAvatar"
            data-dropdown
            :class="isMobile
              ? 'fixed top-[60px] left-3 right-3 z-[200] max-h-[calc(100dvh-5rem)] overflow-y-auto bg-white border border-[#E4E4E7] rounded-[14px] shadow-[0_1px_2px_rgba(0,0,0,0.02),0_24px_60px_-20px_rgba(10,10,10,0.18)] animate-in fade-in slide-in-from-top-2 duration-200'
              : 'absolute right-0 top-full mt-1.5 w-[280px] bg-white border border-[#E4E4E7] rounded-[14px] shadow-[0_1px_2px_rgba(0,0,0,0.02),0_24px_60px_-20px_rgba(10,10,10,0.18)] overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-200'"
          >
            <!-- User info -->
