  ...
  <div class="sticky top-0 z-30 w-full flex flex-col">
    ...
    <div class="flex items-center gap-1.5 ml-auto">
      ...
      <div class="relative" data-dropdown>
        ...
        <Teleport to="body" v-if="isMobile && showNotifications">
          <div class="fixed inset-0 z-[199] bg-black/20" @click="showNotifications = false"></div>
          <div
            data-dropdown
      ...
      <div class="relative" data-dropdown>
        ...
        <Teleport to="body" v-if="isMobile && showAvatar">
          <div class="fixed inset-0 z-[199] bg-black/20" @click="showAvatar = false"></div>
          <div
            data-dropdown
            class="fixed top-[60px] left-3 right-3 z-[200] max-h-[calc(100dvh-5rem)] overflow-y-auto bg-white border border-[#E4E4E7] rounded-[14px] shadow-[0_1px_2px_rgba(0,0,0,0.02),0_24px_60px_-20px_rgba(10,10,10,0.18)] overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-200"
          >
