  ...
  >
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      <div class="bg-white border border-[#E4E4E7] rounded-[14px] p-5">
        <p class="text-[11px] font-semibold text-[#A1A1AA] uppercase tracking-wider mb-2">
          Ingresos proyectados
        </p>
        <div class="flex items-baseline gap-2">
          <p class="text-[22px] font-bold text-[#18181B] tracking-[-0.02em] font-mono">
            $ 4.2M
          </p><span class="text-[11px] font-semibold text-emerald-700">↑ 12%</span>
        </div>
      ...
      <div class="bg-white border border-[#E4E4E7] rounded-[14px] p-5">
        ...
        <div class="flex items-baseline gap-2">
          <p class="text-[22px] font-bold text-[#18181B] tracking-[-0.02em]">
            22%
          </p><span class="text-[11px] font-semibold text-emerald-700">↑ 2.5%</span>
        </div>
        <p class="text-[11px] text-[#71717A] mt-1">
          vs mes anterior
        </p>
      ...
      <div class="bg-white border border-[#E4E4E7] rounded-[14px] p-5">
        ...
        <p class="text-[22px] font-bold text-emerald-700 tracking-[-0.02em]">
          Alcanzado
        </p>
        <p class="text-[11px] text-[#71717A] mt-1">
          Estimado: 15 jun
      ...
      <div class="bg-white border border-[#E4E4E7] rounded-[14px] p-5">
        ...
        <p class="text-[11px] text-[#2563EB] font-semibold mt-1 flex items-center gap-1">
          <span class="material-symbols-outlined text-[12px]">auto_awesome</span>Análisis IA
        </p>
      </div>
    </div>
        ...
        <table class="w-full text-left min-w-[500px]">
          ...
          <tbody class="text-[13px] divide-y divide-[#F4F4F5]">
            <tr class="hover:bg-[#FAFAFA]">
              ...
              <td class="px-5 py-3.5 font-mono text-[12px] text-[#71717A]">
                01 may 2026
              </td>
              ...
              <td class="px-5 py-3.5">
                <span class="inline-flex px-2 py-0.5 rounded-md bg-emerald-50 text-emerald-700 text-[11px] font-semibold">Listo</span>
              </td>
            ...
            <tr class="hover:bg-[#FAFAFA]">
              ...
              <td class="px-5 py-3.5">
                <span class="inline-flex px-2 py-0.5 rounded-md bg-amber-50 text-amber-700 text-[11px] font-semibold">Procesando</span>
              </td>
              <td class="px-5 py-3.5 text-right">
                <button class="text-[#A1A1AA] hover:text-[#18181B]">
