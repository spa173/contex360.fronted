...
const milestones = [
  { year: '2022', event: 'Fundación de Contex360 en Bogotá.' },
  { year: '2023', event: 'Primera certificación como proveedor tecnológico DIAN.' },
  { year: '2024', event: 'Superamos las 200 empresas activas y $1B en facturas procesadas.' },
