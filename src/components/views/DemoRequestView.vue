      ...
      <div class="max-w-7xl w-full grid lg:grid-cols-[1fr_540px] gap-14 lg:gap-20 items-center">
        ...
        <div class="space-y-12 animate-in fade-in slide-in-from-left-4 duration-700">
          <div class="space-y-6 max-w-[560px]">
            ...
            <h1
              class="text-[44px] lg:text-[56px] leading-[1.02] tracking-[-0.03em] font-bold text-[#18181B]"
        ...
        <div class="relative w-full animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          >
            ...
            <h3 class="text-[22px] font-bold text-[#18181B] mb-2 tracking-tight">
              ¡Solicitud Enviada!
            </h3>
            <p class="text-[14px] text-[#71717A] mb-7 font-medium max-w-sm">
              {{ successMessage }}
            </p>
            <button
              class="text-[#2563EB] font-semibold text-[14px] hover:underline"
          ...
          <div class="bg-white rounded-[18px] border border-[#E4E4E7] p-8 lg:p-9 shadow-[0_1px_2px_rgba(0,0,0,0.02),0_24px_60px_-20px_rgba(10,10,10,0.12)]">
            ...
            <p class="text-[13px] text-[#71717A] mb-7">
              Un experto lo contactará en menos de 24 horas laborables.
            </p>
            ...
            >
              ...
              <div
                v-if="errorMessage"
                class="p-3 bg-red-50 border border-red-100 text-red-600 text-[12px] font-bold rounded-[10px]"
              >
                {{ errorMessage }}
              </div>
