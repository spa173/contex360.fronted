    ...
    <div class="w-full max-w-3xl">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-gray-500 mt-2">
          Completa estos pasos para empezar a usar Contex360
        </p>
      </div>
        ...
        >
          <div class="flex items-center">
            ...
            <div
              ...
              class="w-8 h-px mx-1 bg-gray-300"
            />
          </div>
        </template>
      </div>
            ...
            >
              ...
              <div class="text-center mt-1">
                ...
                <ul class="mt-4 space-y-2 text-left">
                  ...
                  >
                    <svg
                      class="w-4 h-4 mt-0.5 text-green-500 shrink-0"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
          ...
          <div class="mt-6 p-4 bg-blue-50 border border-blue-100 rounded-xl space-y-3">
            ...
            <label class="flex items-start gap-3 cursor-pointer group">
              ...
              <span class="text-sm text-gray-700 group-hover:text-gray-900">
                ...
                >Términos y Condiciones</a> de Contex360
              </span>
            </label>
            <label class="flex items-start gap-3 cursor-pointer group">
              <input
              ...
              <span class="text-sm text-gray-700 group-hover:text-gray-900">
                Acepto la <a
                  ...
                  target="_blank"
                  class="text-blue-600 underline"
                >Política de Privacidad</a> y el tratamiento de mis datos personales según la Ley 1581 de 2012
              </span>
            </label>
            <label class="flex items-start gap-3 cursor-pointer group">
              <input
