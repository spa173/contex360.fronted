            ...
            <form @submit.prevent="handleSubmit" class="space-y-5">
              ...
              <div class="space-y-3 pt-1">
                ...
                <label class="flex items-center gap-3 cursor-pointer group" for="rememberMe">
                  <input id="rememberMe" name="rememberMe" autocomplete="off" v-model="rememberMe" type="checkbox" class="w-4 h-4 flex-shrink-0 rounded border-[#E4E4E7] text-[#2563EB] focus:ring-[#2563EB]/20 transition-all" />
