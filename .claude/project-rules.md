# Reglas del Proyecto — Contex360 Frontend

Este archivo define el proceso obligatorio, reglas de calidad y restricciones críticas para el desarrollo en `contex360.fronted`. Aplica a cualquier agente o desarrollador que modifique este repositorio.

---

## 1. Proceso Obligatorio
...
## 6. Lazy Rendering de Componentes
...
## 8. OCR — Módulo de Reconocimiento (Crítico)
...
- No usar `any` explícito. Si es inevitable, justificar con comentario.
